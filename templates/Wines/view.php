...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Wine'), ['action' => 'edit', $wine->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Wine'), ['action' => 'delete', $wine->id], ['confirm' => __('Are you sure you want to delete # {0}?', $wine->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Wines'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Wine'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="wines view content">
            <h3><?= h($wine->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($wine->vintages as $vintages) : ?>
                        <tr>
                            <td><?= h($vintages->id) ?></td>
